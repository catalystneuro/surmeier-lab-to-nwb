...
def convert_data_to_nwb(session_folder_path: Path, condition: str, verbose: bool = False) -> NWBFile:
    ...
    # Create subject metadata for Figure 2 spine density experiments
    subject = Subject(
...
if __name__ == "__main__":
    ...
    for condition in conditions:
        ...
        session_iterator = (
            tqdm(session_folders, desc=f"Converting {condition} from figure_2_spine_density to NWB", disable=verbose)
            if not verbose
