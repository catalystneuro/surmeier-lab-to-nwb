...
class BrukerBOTSegmentationInterface(BaseSegmentationExtractorInterface):
    ...
    def add_to_nwbfile(self, nwbfile, metadata=None, **kwargs):
        ...
        # The neuroconv writer calls nwbfile.create_device(**device_metadata), so any kwarg
        # in the Device entry is forwarded; injecting model wires the DeviceModel link.
