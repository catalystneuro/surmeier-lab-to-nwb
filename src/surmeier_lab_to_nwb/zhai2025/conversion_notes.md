...
checkin the metadata for one channel
```
...
## First Email:
  ...
  I reviewed the data that has been transferred so far and here is what we are missing in terms of the scope of work that we agreed on. We have now imaging voltage and Line profiles from teh Bruker systems corresponding to figures 1 and 3.
